	...
	<div class="container">
		<div class="header-row justify-content-between">
			...
			<div id="logo" class="col-auto ms-auto ms-mb-0 me-mb-0 order-md-2">
				...
				<a href="<?php echo site_url(); ?>" class="retina-logo"><img class="mx-auto" src="<?php echo base_url('assets/images/website/logo@2x.png'); ?>" alt="Lifelong Learning"></a>
			</div><!-- #logo end -->
			...
			<div class="col-12 col-sm-6 col-md-4 justify-content-center justify-content-sm-start d-flex order-md-1 mb-4 mb-sm-0">
				...
				<a href="https://twitter.com/__semicolon" class="social-icon si-small si-rounded si-dark si-mini si-spotify mb-0">
					<i class="icon-line" style="font-size:16px"></i>
					<i class="icon-line" style="font-size:16px"></i>
				</a>
				<a href="https://instagram.com/semicolonweb" class="social-icon si-small si-rounded si-dark si-mini si-bitbucket mb-0">
			...
			<div class="header-row justify-content-between flex-row-reverse flex-lg-row">
				...
				<nav class="primary-menu with-arrows">
					...
					<ul class="menu-container">
						<li class="menu-item current menu-color-home"><a class="menu-link" href="demo-news.html">
								<div>Home</div>
							</a></li>
						<li class="menu-item menu-color-tech  mega-menu mega-menu-small"><a class="menu-link" href="demo-news-category.html">
								<div>ABOUT US</div>
							</a>
										...
										<ul class="sub-menu-container mega-menu-column col-lg-6">
											<li class="menu-item mega-menu-title"><a class="menu-link" href="#">
												...
												<ul class="sub-menu-container">
													...
													<li class="menu-item">
														<a class="menu-link" href="header-dark.html">
															<div>โครงสร้างผู้บริหารและบุคลากร</div>
														</a>
													</li>
												</ul>
											</li>
						...
						<li class="menu-item menu-color-fashion"><a class="menu-link" href="demo-news-category.html">
								<div>NEWS</div>
							</a></li>
						<li class="menu-item menu-color-lifestyle mega-menu"><a class="menu-link" href="demo-news-category.html">
										...
										<ul class="sub-menu-container mega-menu-column col-lg-3">
											<li class="menu-item">
												<div class="nav nav-sm tab-hover flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
													<a class="nav-link bg-color-lifestyle active" id="v-pills-home-tab" data-bs-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true">หลักสูตรที่กำลังเปิดรับสมัคร</a>
													<a class="nav-link bg-color-lifestyle" id="v-pills-profile-tab" data-bs-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false">หลักสูตรทั้งหมด</a>
													<a class="nav-link bg-color-lifestyle" id="v-pills-messages-tab" data-bs-toggle="pill" href="#v-pills-messages" role="tab" aria-controls="v-pills-messages" aria-selected="false">เครือข่ายความร่วมมือ</a>
													<a class="nav-link bg-color-lifestyle" id="v-pills-settings-tab" data-bs-toggle="pill" href="#v-pills-settings" role="tab" aria-controls="v-pills-settings" aria-selected="false">อาจารย์ & วิทยากร</a>
												</div>
											</li>
										</ul>
													...
													<div class="tab-pane show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
														<div class="row justify-content-around posts-md">
															<div class="col-4">
																<div class="entry">
																	<div class="entry-image mb-3">
																		<a href="demo-news-single.html"><img src="<?php echo CANVAS; ?>demos/news/images/posts/lifestyle/1.jpg" alt="Image 3"></a>
															...
															<div class="col-4">
																<div class="entry">
																	<div class="entry-image mb-3">
																		<a href="demo-news-single.html"><img src="<?php echo CANVAS; ?>demos/news/images/posts/lifestyle/meditation.jpg" alt="Image 3"></a>
															...
															<div class="col-4">
																<div class="entry">
																	<div class="entry-image mb-3">
																		<a href="demo-news-single.html"><img src="<?php echo CANVAS; ?>demos/news/images/posts/lifestyle/3.jpg" alt="Image 3"></a>
													...
													<div class="tab-pane" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
														<div class="row justify-content-around posts-md">
															<div class="col-4">
																<div class="entry">
																	<div class="entry-image mb-3">
																		<a href="demo-news-single.html"><img src="<?php echo CANVAS; ?>demos/news/images/posts/lifestyle/2.jpg" alt="Image 3"></a>
															...
															<div class="col-4">
																<div class="entry">
																	<div class="entry-image mb-3">
																		<a href="demo-news-single.html"><img src="<?php echo CANVAS; ?>demos/news/images/posts/lifestyle/party.jpg" alt="Image 3"></a>
															...
															<div class="col-4">
																<div class="entry">
																	<div class="entry-image mb-3">
																		<a href="demo-news-single.html"><img src="<?php echo CANVAS; ?>demos/news/images/posts/lifestyle/movies.jpg" alt="Image 3"></a>
						...
						<li class="menu-item menu-color-home sub-menu"><a class="menu-link" href="demo-news-category.html">
								<div>Credit bank</div>
							</a>
							<ul class="sub-menu-container border-top-0" style="width:250px;">
								<li class="menu-item">
									<a class="menu-link" href="header-light.html">
										<div>สะสมหน่วยกิต</div>
									</a>
								</li>
								<li class="menu-item">
									<a class="menu-link" href="header-dark.html">
						...
						<li class="menu-item menu-color-market"><a class="menu-link" href="demo-news-category.html">
								<div>CRRU CWIE</div>
							</a></li>
							<li class="menu-item menu-color-travel sub-menu"><a class="menu-link" href="demo-news-category.html">
								<div>Ceramic</div>
							</a>
							<ul class="sub-menu-container border-top-0" style="width:250px;">
								<li class="menu-item">
									<a class="menu-link" href="header-light.html">
										<div>สั่งผลิตภัณฑ์เซรามิก</div>
									</a>
								</li>
								<li class="menu-item">
									<a class="menu-link" href="header-dark.html">
										<div>เกี่ยวกับเซรามิก มร.ชร.</div>
									</a>
								</li>
							</ul>
						</li>
					...
					<ul class="menu-container mobile-primary-menu">
						...
						<li class="menu-item menu-color-travel"><a class="menu-link" href="demo-news-category.html">
								<div>Travel</div>
							</a></li>
						<li class="menu-item menu-color-lifestyle"><a class="menu-link" href="demo-news-category.html">
								<div>Lifestyle</div>
							</a></li>
						<li class="menu-item menu-color-tech"><a class="menu-link" href="demo-news-category.html">
								<div>Tech</div>
							</a></li>
						<li class="menu-item menu-color-fashion"><a class="menu-link" href="demo-news-category.html">
								<div>Fashion</div>
							</a></li>
						<li class="menu-item menu-color-sports"><a class="menu-link" href="demo-news-category.html">
								<div>Sports</div>
							</a></li>
						<li class="menu-item menu-color-food"><a class="menu-link" href="demo-news-category.html">
								<div>Food</div>
							</a></li>
						<li class="menu-item menu-color-market"><a class="menu-link" href="demo-news-category.html">
								<div>More</div>
							...
							<ul class="sub-menu-container">
								<li class="menu-item mega-menu-title"><a class="menu-link" href="#">
									...
									<ul class="sub-menu-container">
										...
										<li class="menu-item">
											<a class="menu-link" href="blog-single-both-sidebar.html">
