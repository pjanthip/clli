<section id="content">
                <div class="content-wrap pt-5 pb-0">
                    ...
                    <div class="fancy-title title-bottom-border mb-5">
						<h1><span class="font-sarabun text-dark">โครงสร้างผู้บริหารและบุคลากร (PERSONELS)</span></h1>
					</div>

                        <div class="fslider testimonial testimonial-full bottommargin" data-animation="fade" data-arrows="false">
    <div class="flexslider" style="height: 162.5px;">
...
<div class="fslider testimonial testimonial-full bottommargin" data-animation="fade" data-arrows="false">
    <div class="flexslider" style="height: 182px;">
        <div class="slider-wrap">
            <div class="slide flex-active-slide" style="width: 100%; float: left; margin-right: -100%; position: relative; opacity: 1; display: block; z-index: 2;">
                <div class="testi-image">
...
<div class="fslider testimonial testimonial-full bottommargin" data-animation="fade" data-arrows="false">
    <div class="text-end">
        <span class="font-sarabun font-10 text-secondary"><i class="fa-solid fa-star"></i> ฝ่ายงานบริหารทั่วไป</span><br/>
        <span class="font-sarabun text-secondary fst-italic" style="font-size:12px;">Office</span>
    </div>
    <div class="flexslider" style="height: 182px;">
        <div class="slider-wrap">
            <div class="slide flex-active-slide" style="width: 100%; float: left; margin-right: -100%; position: relative; opacity: 1; display: block; z-index: 2;">
                <div class="testi-image">
                    <a href="<?php echo base_url('assets/images/personnels/04.jpg')?>" data-lightbox="image"><img src="<?php echo base_url('assets/images/personnels/04.jpg')?>" alt="นางสาววิไลพร ริ้วสุวรรณ" draggable="false"></a>
                </div>
                <div class="testi-content">
                    <div class="testi-meta non-meta">นางสาววิไลพร ริ้วสุวรรณ<span>เจ้าหน้าที่บริหารงานทั่วไป ชำนาญการ<br>หัวหน้าสำนักงาน</span></div>
                </div>
            </div>
        </div>
    <ol class="flex-control-nav flex-control-paging"></ol></div>
...
<div class="fslider testimonial testimonial-full bottommargin" data-animation="fade" data-arrows="false">
    <div class="text-end">
        <span class="font-sarabun font-10 text-secondary"><i class="fa-solid fa-star"></i> ฝ่ายงานคลังหน่วยกิต</span><br/>
        <span class="font-sarabun text-secondary fst-italic" style="font-size:12px;">Creditbank : CB</span>
    </div>
    <div class="flexslider" style="height: 182px;">
        <div class="slider-wrap">
            <div class="slide flex-active-slide" style="width: 100%; float: left; margin-right: -100%; position: relative; opacity: 1; display: block; z-index: 2;">
                <div class="testi-image">
                    <a href="<?php echo base_url('assets/images/personnels/03.jpg')?>" data-lightbox="image"><img src="<?php echo base_url('assets/images/personnels/03.jpg')?>" alt="นางสาวดวงรัตน์ อินพรม" draggable="false"></a>
                </div>
                <div class="testi-content">
                    <div class="testi-meta non-meta">นางสาวดวงรัตน์ อินพรม<span>นักวิชาการศึกษา<br>หัวหน้าฝ่ายงาน</span></div>
                </div>
            </div>
        </div>
    <ol class="flex-control-nav flex-control-paging"></ol></div>
...
<div class="fslider testimonial testimonial-full bottommargin" data-animation="fade" data-arrows="false">
    <div class="text-end">
        <span class="font-sarabun font-10 text-secondary"><i class="fa-solid fa-star"></i> ฝ่ายงานบูรณาการเรียนรู้กับการทำงาน</span><br/>
        <span class="font-sarabun text-secondary fst-italic" style="font-size:12px;">Cooperative and Work Integrated Education : CWIE</span>
    </div>
    <div class="flexslider" style="height: 182px;">
        <div class="slider-wrap">
            <div class="slide flex-active-slide" style="width: 100%; float: left; margin-right: -100%; position: relative; opacity: 1; display: block; z-index: 2;">
...
<div class="fslider testimonial testimonial-full bottommargin" data-animation="fade" data-arrows="false">
    <div class="text-end">
        <span class="font-sarabun font-10 text-secondary"><i class="fa-solid fa-star"></i> ฝ่ายงานเทคโนโลยีสารสนเทศ</span><br/>
        <span class="font-sarabun text-secondary fst-italic" style="font-size:12px;">Information Technology : IT</span>
    </div>
    <div class="flexslider" style="height: 182px;">
        <div class="slider-wrap">
            <div class="slide flex-active-slide" style="width: 100%; float: left; margin-right: -100%; position: relative; opacity: 1; display: block; z-index: 2;">
