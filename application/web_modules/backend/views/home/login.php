...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo eliteadmin;?>assets/images/favicon.png">
    <title><?php echo $title;?></title>
    
    <!-- page css -->
    <link href="<?php echo eliteadmin;?>university/dist/css/pages/login-register-lock.css" rel="stylesheet">
    <!-- Custom CSS -->
...
<body class="skin-default card-no-border">
    ...
    <!-- ============================================================== -->
    <section id="wrapper">
        <div class="login-register" style="background-image:url(<?php echo eliteadmin;?>assets/images/background/login-register.jpg);">
            <div class="login-box card">
                <div class="card-body">
                    
                <?php echo form_open('backend/login/on_login');?>
    ...
    <!-- All Jquery -->
    <!-- ============================================================== -->
    <script src="<?php echo eliteadmin;?>assets/node_modules/jquery/dist/jquery.min.js"></script>
